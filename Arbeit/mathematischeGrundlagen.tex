...
Auf diese Untersuchung wird jedoch in dieser Arbeit verzichtet, da das Modell sonst zu komplex für die Behandlung im Unterricht wird.
...
\end{figure}
In der Darstellung \ref{fig:ssec:model} entspricht $\alpha$ der Reproduktionsrate, also der Anzahl der Gesunden, die durch einen Infektiösen angesteckt werden. Forscher der Eidgenössischen Technischen Hochschule Zürich (ETH Zürich) stellten fest, dass diese Rate bei Ebola etwa bei 2,18 liegt (\cite{Stadler2014}).\\
