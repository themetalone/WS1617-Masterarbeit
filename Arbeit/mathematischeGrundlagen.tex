...
\end{figure}
In der obigen Darstellung entspricht $\alpha$ der Reproduktionsrate, also der Anzahl der Gesunden, die durch einen Infektiösen angesteckt werden. Forscher der Eidgenössischen Technischen Hochschule Zürich (ETH Zürich) stellten fest, dass diese Rate bei Ebola etwa bei 2,18 liegt.\\
...
%TODO Literaturangabe (http://currents.plos.org/outbreaks/article/insights-into-the-early-epidemic-spread-of-ebola-in-sierra-leone-provided-by-viral-sequence-data/)
Caitlin Rivers et al. geben in ihrem Paper an, dass die Sterblichkeitsrate durch Krankenhausaufenthalte nicht verändert wird.
%TODO Literaturangabe Caitlin M Rivers (1. Paper)
Eine Studie von Ärzte ohne Grenzen kommt jedoch zu dem Schluss, dass ein Malariamedikament die Sterblichkeitsrate um 31\% senkt. 
%TODO Literaturangabe res/bib/aog
