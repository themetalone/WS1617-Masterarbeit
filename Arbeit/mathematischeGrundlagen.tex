...
\cite{Rivers} geben in ihrem Paper an, dass die Sterblichkeitsrate durch Krankenhausaufenthalte nicht verändert wird. Eine Studie von Ärzte ohne Grenzen kommt jedoch zu dem Schluss, dass ein Malariamedikament die Sterblichkeitsrate um 31\% senkt (\cite{AerzteGrenzen2016}).
