...
CREATE TABLE IF NOT EXISTS PANDEMIC.POPILATIONS (POPID INTEGER, NAME VARCHAR(255), LIFE FLOAT, MIGRATION FLOAT, PRIMARY KEY (POPID));
...
CREATE TABLE IF NOT EXISTS PANDEMIC.TRANSMISSIONS (SRCPOPID INTEGER, SRCHSID INTEGER, TRGPOPID INTEGER, TRGHSID INTEGER, TYPE INTEGER, PRIORITY INTEGER, DESCRIPTION VARCHAR(255), PRIMARY KEY(SRCPOPID, SRCHSID, TRGPOPID, TRGHSID, TYPE), FOREIGN KEY (SRCPOPID, SRCHSID) REFERENCES PANDEMIC.HEALTHSTATES (POPID, HSID), FOREIGN KEY (TRGPOPID, TRGHSID) REFERENCES PANDEMIC.HEALTHSTATES (POPID, HSID));
CREATE TABLE IF NOT EXISTS PANDEMIC.TRANSMISSIONSTATES (SRCPOPID INTEGER, SRCHSID INTEGER, TRGPOPID INTEGER, TRGHSID INTEGER, TYPE INTEGER, TICK BIGINT, VALUE BIGINT, PRIMARY KEY(SRCPOPID, SRCHSID, TRGPOPID, TRGHSID, TYPE, TICK), FOREIGN KEY (SRCPOPID, SRCHSID, TRGPOPID, TRGHSID, TYPE) REFERENCES PANDEMIC.TRANSMISSIONS (SRCPOPID, SRCHSID, TRGPOPID, TRGHSID, TYPE));
